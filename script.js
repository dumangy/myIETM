    ...
    const questions = {
      dataLoss: [
        { id: "q1", question: "Есть ли резервная копия данных?", answers: [
            { text: "Да", result: "Восстановите данные из резервной копии и завершите диагностику." },
            { text: "Нет", next: "q2" }
        ]},
        { id: "q2", question: "Есть возможность восстановить данные вручную?", answers: [
            { text: "Да", result: "Произведите ручное восстановление данных и завершите диагностику." },
            { text: "Нет", result: "Обратитесь к специалисту: ivan@prnwatch.com" }
        ]}
      ],
      calculationErrors: [
        { id: "q1", question: "Корректно ли настроены тарифы и скидки?", answers: [
            { text: "Нет", result: "Выполните корректировку тарифов и скидок и завершите диагностику." },
            { text: "Да", next: "q2" }
        ]},
      ...
      processingDelay: [
        { id: "q1", question: "Система перегружена?", answers: [
            { text: "Да", result: "Оптимизируйте нагрузку на систему и завершите диагностику." },
            { text: "Нет", next: "q2" }
        ]},
        { id: "q2", question: "Перезапуск системы решил проблему?", answers: [
            { text: "Да", result: "Диагностика завершена." },
      ...
      integrationErrors: [
        { id: "q1", question: "Доступна ли внешняя система?", answers: [
            { text: "Нет", result: "Ожидайте восстановления работы внешней системы и завершите диагностику." },
            { text: "Да", next: "q2" }
        ]},
        { id: "q2", question: "Корректны ли API ключи и настройки доступа?", answers: [
            { text: "Нет", result: "Обновите API ключи, проверьте настройки доступа и завершите диагностику." },
            { text: "Да", next: "q3" }
        ]},
        { id: "q3", question: "Соответствует ли формат данных требованиям внешней системы?", answers: [
            { text: "Нет", result: "Скорректируйте формат данных и завершите диагностику." },
            { text: "Да", result: "Проверьте наличие ошибок в коде или обратитесь к специалисту: ivan@prnwatch.com" }
        ]}
      ]
    };
